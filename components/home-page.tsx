...
export default function HomePage() {
  ...
  useEffect(() => {
    const savedLeaderboard = localStorage.getItem('ritdefense-leaderboard');
    if (savedLeaderboard) {
  ...
  if (gameMode === 'defense') {
    return <DefenseGame onBack={() => setGameMode('home')} onGameEnd={(score) => saveScore(score)} />;
  }
        ...
        <div className="flex justify-center space-x-4">
          <Dialog>
            ...
            <DialogContent className="bg-gray-900/95 border-white/20 text-white max-w-md">
              <DialogHeader>
                <DialogTitle className="text-xl font-bold text-center mb-4">How to Play RitDefense</DialogTitle>
              </DialogHeader>
